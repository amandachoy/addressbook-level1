...
public class AddressBook {
    ...
    private static void showToUser(String ... value) {
    	for (String m: value){
    ...
    private static void showToUser(String result, String divider) {
    ...
    private static void showToUser(String message, String divider1, String divider2) {
    	System.out.println(LINE_PREFIX + message);
    	System.out.println(LINE_PREFIX + divider1);
    	System.out.println(LINE_PREFIX + divider2);
    }
     ...
     *
     * @param toBeDisplayed used to generate summary
...
;
    ...
    */
     ...
     */
    private static Collection<? extends HashMap<PersonProperty, String>> loadPersonsFromFile(String filePath) {
    ...
    private static boolean deletePersonFromAddressBook(HashMap<PersonProperty, String> targetInModel) {
        if (ALL_PERSONS.remove(targetInModel)) {
        	savePersonsToFile(getAllPersonsInAddressBook(), storageFilePath);
        	return true;
        } else {
        	return false;
     ...
     */
    private static void initialiseAddressBookModel(Collection<? extends HashMap<PersonProperty, String>> persons) {
        ALL_PERSONS.clear();
    ...
    /**
     * @param addedPerson whose phone number you want
     * @return person's phone number
     */
    private static String getPhoneFromPerson(HashMap<PersonProperty, String> addedPerson) {
    	return addedPerson.get(PersonProperty.PHONE);
    }

    /**
     * @param addedPerson whose email you want
     * @return person's email
     */
    private static String getEmailFromPerson(HashMap<PersonProperty, String> addedPerson) {
    	return addedPerson.get(PersonProperty.EMAIL);
    }
